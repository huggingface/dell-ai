...
def printer_echo_mock(monkeypatch):
    """
    Fixture to mock the Printer function, used in validating compare method outputs
    """
...
def mock_sys_info():
    """
    Fixture that returns a mock system information object, generated by using the commandline_patches fixture.
    """
    with open(
